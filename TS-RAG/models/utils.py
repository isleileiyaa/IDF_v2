...
try:
    ...
    # This path moved/was removed in newer autogluon releases. Only
    # ChronosFineTuningDataset below needs it (fine-tuning, not zero-shot
    # inference), so defer the failure instead of blocking this whole module
    # (and everything downstream, e.g. ChronosBoltRetrieve) from importing.
    SimpleGluonTSDataset = None
