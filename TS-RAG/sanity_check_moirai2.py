"""
Sanity check for models/Moirai2.py -- NOT a training script.
...
from models.Moirai2 import NEW_HEAD_LAYER_NAMES, Moirai2ModelForForecastingWithRetrieval
...
def main():
    ...
    for expected in NEW_HEAD_LAYER_NAMES:
