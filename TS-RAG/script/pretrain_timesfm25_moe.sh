...
# TimesFM25 backbone (see models/TimesFM25.py): 'moe' for the plain moe-fusion
# port (mirrors models/ChronosBolt.py's _run_moe_fusion), 'idf_clean_dis' for
# the RIDDE port (script/pretrain_timesfm25_idf_clean_dis.sh).
augment_mode=moe
context_length=512
...
echo "Launching TimesFM25 moe pretrain"
