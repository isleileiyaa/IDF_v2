...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_clean_dis_deepmlp${save_suffix:+_${save_suffix}}.txt}"
...
lookback_length=512
augment_mode=idf_clean_dis_deepmlp
top_k=10
rho1=${1:-${RHO1:-0}}
rho2=${2:-${RHO2:-0}}
rho3=${3:-${RHO3:-0}}
...
default_checkpoint_model_path="/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_clean_dis_deepmlp_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_no_embeddingtuning_rho${rho1}_${rho2}_${rho3}_${rho4}_final.pth"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_idf_clean_dis_deepmlp" \
    --data $data \
    --top_k $top_k \
