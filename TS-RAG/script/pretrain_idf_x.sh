...
data_path="${PRETRAIN_DATA_PATH:-/home/fenglei/TS-RAG-main/datasets/pretrain/pretrain_pairs_ctx${retrieve_lookback_length}_rawx}"
...
python $run_file \
    ...
    --data_path /home/fenglei/TS-RAG-main/datasets/pretrain/pretrain_pairs_ctx512_rawx \
