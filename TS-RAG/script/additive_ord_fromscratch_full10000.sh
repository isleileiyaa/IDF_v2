...
mkdir -p "$checkpoints"
echo "Launching pretrain (fromscratch, no init_from_checkpoint) with rho=($rho1, $rho2, $rho3, $rho4), tau_dis=$tau_dis, fusion_mode=$fusion_mode, lambda_ord=$lambda_ord, ord_margin=$ord_margin, tau=$tau"
