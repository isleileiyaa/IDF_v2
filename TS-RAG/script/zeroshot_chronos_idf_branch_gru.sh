...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_branch_gru${save_suffix:+_${save_suffix}}.txt}"
...
checkpoint_model_path="${CHECKPOINT_MODEL_PATH:-/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_branch_gru_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step200_bs32_no_embeddingtuning_final.pth}"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_idf_branch_gru" \
    --data $data \
    --top_k $top_k \
