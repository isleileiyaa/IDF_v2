...
model_id="idf_clean_dis_v3_frozennative_additive_full10000_tau017"
...
head_mode=frozen_native

mkdir -p "$checkpoints"
echo "Launching pretrain (fromscratch, no init_from_checkpoint) with rho=($rho1, $rho2, $rho3, $rho4), tau_dis=$tau_dis"
echo "fusion_mode=$fusion_mode head_mode=$head_mode (v3 frozen-native-head experiment)"
