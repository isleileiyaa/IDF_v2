...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_gate${save_suffix:+_${save_suffix}}.txt}"
...
batch_size=256
retrieval_database_dir="${RETRIEVAL_DATABASE_DIR:-/home/fenglei/TS-RAG-main/retrieval_database/}"
...
checkpoint_model_path="${CHECKPOINT_MODEL_PATH:-/home/fenglei/TS-RAG-main/checkpoints/data50m_gate_512_pred64_lookback512_top10_lr0.00003_drop0.0_adamw_cosanneal_step10000_bs256_no_embeddingtuning/model_steps9999.pth}"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_gate" \
    --data $data \
    --top_k $top_k \
