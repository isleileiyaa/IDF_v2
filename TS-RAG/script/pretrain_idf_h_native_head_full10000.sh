...
model_id="idf_h_native_head_fromscratch_full10000"
...
mkdir -p "$checkpoints"
echo "Launching pretrain (idf_h_native_head, fromscratch, no init_from_checkpoint), evaluation_steps=$evaluation_steps"
