...
save_suffix="_512model_64seq"
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_clean_dis${save_suffix}.txt}"
...
ett_root_path="/home/fenglei/TS-RAG-main/datasets/ETT-small/"
custom_datasets_root="/home/fenglei/TS-RAG-main/datasets/"
pretrained_model_path="/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/base/"
checkpoint_model_path="/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_clean_dis_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_no_embeddingtuning_rho${rho1}_${rho2}_${rho3}_${rho4}_final.pth"

echo "========================================"
echo "Running zeroshot with 512 model"
echo "Checkpoint: $checkpoint_model_path"
echo "Sequence length: $seq_len"
echo "Lookback length: $lookback_length"
echo "========================================"
