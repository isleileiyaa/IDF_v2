...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_x.txt}"
...
augment_mode=idf_x
top_k=10
rawx_norm="${RAWX_NORM:-zscore}"
retrieval_mode="${RETRIEVAL_MODE:-raw_x}"
...
checkpoint_model_path="${CHECKPOINT_MODEL_PATH:-/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_x_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_no_embeddingtuning_rho0.005_0.005_0.005_0.0005/model_steps9999.pth}"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_idf_x" \
    --data $data \
    --top_k $top_k \
