...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_h_linear_head${save_suffix:+_${save_suffix}}.txt}"
...
lookback_length=512
augment_mode=idf_h_linear_head
top_k=10
...
checkpoint_model_path="${CHECKPOINT_MODEL_PATH:-/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_h_linear_head_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_no_embeddingtuning/model_steps9999.pth}"
# default_ckpt="/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_h_linear_head_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_no_embeddingtuning_final.pth"
# checkpoint_model_path="${1:-$default_ckpt}"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_idf_h_linear_head" \
    --data $data \
    --top_k $top_k \
