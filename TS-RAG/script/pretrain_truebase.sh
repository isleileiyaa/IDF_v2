...
echo "PRETRAIN_SEED=${PRETRAIN_SEED:-2021}(必须和真实 RAG 训练用的种子一致!)"

model_id="data50m_${augment_mode}_${context_length}_pred${prediction_length}_lookback${retrieve_lookback_length}_top${top_k}_lr${lr}_drop${drop_prob}_${optimizer}_cosanneal_step${train_steps}_bs${batch_size}_no_embeddingtuning_seed${PRETRAIN_SEED:-2021}"
