...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_dual_direct_head${save_suffix:+_${save_suffix}}.txt}"
...
datasets="ETTh1"
lookback_length=512
augment_mode=idf_dual_direct_head
top_k=10
...
checkpoint_model_path="${CHECKPOINT_MODEL_PATH:-/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/data50m_idf_dual_direct_head_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step100_bs32_no_embeddingtuning_final.pth}"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_idf_dual_direct_head" \
    --data $data \
    --top_k $top_k \
