...
filename="${SAVE_FILE_NAME:-zeroshot_chronos_idf_branch_gru_q${save_suffix:+_${save_suffix}}.txt}"
...
checkpoint_model_path="${CHECKPOINT_MODEL_PATH:-/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/idf_branch_gru_q_final.pth}"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_idf_branch_gru_q" \
    --data $data \
    --top_k $top_k \
