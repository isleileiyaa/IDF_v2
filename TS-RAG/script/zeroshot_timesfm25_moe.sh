...
filename="${SAVE_FILE_NAME:-zeroshot_timesfm25_moe${save_suffix:+_${save_suffix}}.txt}"
...
# NOTE: TimesFM25MoEModelForForecastingWithRetrieval does not read
...
default_checkpoint_model_path="/home/fenglei/TS-RAG-main/TS-RAG/checkpoints/timesfm25_moe_512_pred64_lookback512_top10_lr0.0003_drop0.2_adamw_cosanneal_step10000_bs256_final.pth"
...
python $run_file \
    ...
    --model_id "${dataset}_zeroshot_${seq_len}_pred_${pred_len}_${lookback_length}_retrieve_${pred_len}_timesfm25_moe" \
    --data $data \
    --top_k $top_k \
