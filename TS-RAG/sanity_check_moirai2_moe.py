"""
Sanity check for models/Moirai2.py's Moirai2MoEModelForForecastingWithRetrieval
(the 'moe' fusion port) -- NOT a training script. See sanity_check_moirai2.py
for the RIDDE (idf_clean_dis) variant; this mirrors it for the MoE head.
"""

import torch

from models.Moirai2 import MOE_HEAD_LAYER_NAMES, Moirai2MoEModelForForecastingWithRetrieval
